...
export const config: ModelConfig = {
  ...
  models: [
    ...
    // 'openrouter/free', // The simplest way to get free inference. openrouter/free is a router that selects free models at random from the models available on OpenRouter.
  ],
