...
describe('Chat de Recomendação Musical - Testes E2E', () => {
  ...
  const testDbPath = './preferences.db';
  ...
  it.skip('Deve extrair e salvar preferências do usuário', async () => {
  ...
  it.skip('Deve manter múltiplas trocas e fazer sumarização', async () => {
  ...
  it.skip('Deve compartilhar preferências entre múltiplas threads do mesmo usuário', async () => {
  ...
  it.skip('Deve manter histórico da conversa', async () => {
    ...
    await graph.invoke(
      {
        messages: [
          new HumanMessage('Oi, sou Italo e adoro música pop'),
          new HumanMessage('Sou o Italo!'),
          new HumanMessage('37 anos'),
