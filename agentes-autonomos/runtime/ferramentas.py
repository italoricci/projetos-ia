...
def _chamar_llm_ferramenta(prompt_sistema: str, prompt_usuario: str, campos_saida: dict) -> tuple:
    ...
    print('  [open-router] chamando llm...')
    ...
    cliente = OpenAI(
        ...
        base_url="https://openrouter.ai/api/v1",
         default_headers={
        "HTTP-Referer": "https://italo.com",   # opcional
        "X-Title": "monitor-agent",
        "X-OpenRouter-Title": 'monitor-agent'                     # opcional
        # em algumas docs aparece X-OpenRouter-Title
    }
        )
