...
1. [What is the Model Context Protocol (MCP)? - Model Context Protocol](https://modelcontextprotocol.io/docs/getting-started/intro)
2. [Security Best Practices - Model Context Protocol](https://modelcontextprotocol.io/docs/tutorials/security/security_best_practices)
3. [LangChain overview - Docs by LangChain](https://docs.langchain.com/oss/javascript/langchain/overview)
4. [LangSmith](https://smith.langchain.com/studio)
5. [OpenRouter](https://openrouter.ai/models)
6. [AI Agent Skills](https://www.skills.sh/trending)
